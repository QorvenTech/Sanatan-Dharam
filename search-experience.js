(function () {
  ...
  var resources = [
    ...
    { id:'text-mahabharata', type:'texts', icon:'▤', title:'Mahabharata', hi:'महाभारत', summary:'A transparent hosted-resource reader for the great epic of dharma, choice and human struggle.', keywords:'mahabharat pandava kaurava vyasa epic धर्म पांडव कौरव वेदव्यास', action:'text', target:'mahabharata' },
    { id:'text-vedas', type:'texts', icon:'▤', title:'Four Vedas', hi:'चार वेद', summary:'Hosted editions of Rigveda, Yajurveda, Samaveda and Atharvaveda.', keywords:'rigveda yajurveda samaveda atharvaveda shruti वेद ऋग्वेद यजुर्वेद सामवेद अथर्ववेद', action:'text', target:'vedas' },
    { id:'text-upanishads', type:'texts', icon:'▤', title:'Upanishads', hi:'उपनिषद', summary:'A source-conscious availability guide to the ten principal Upanishads.', keywords:'vedanta atman brahman isha kena katha prashna mundaka mandukya taittiriya aitareya chandogya brihadaranyaka वेदान्त आत्मा ब्रह्म उपनिषद', action:'text', target:'upanishads' },
    { id:'ramayan-aavahan', type:'texts', icon:'❀', title:'Shri Ramayan Aavahan', hi:'श्री रामायण आवाहन', summary:'A traditional opening prayer before Ramayan paath, with Devanagari and Roman transliteration.', keywords:'ramayan ramcharitmanas invocation opening prayer aavahan avahan आवाहन आह्वान रामायण प्रार्थना', action:'text', target:'ramayan-aavahan' },
    { id:'ramayan-visarjan', type:'texts', icon:'❀', title:'Shri Ramayan Visarjan', hi:'श्री रामायण विसर्जन', summary:'A traditional closing prayer after Ramayan paath, with Devanagari and Roman transliteration.', keywords:'ramayan ramcharitmanas closing prayer visarjan समापन विसर्जन रामायण प्रार्थना', action:'text', target:'ramayan-visarjan' },
    { id:'paath-sundarkand', type:'texts', icon:'❀', title:'Sundar Kand', hi:'सुंदरकांड', summary:'The complete fifth chapter of Ramcharitmanas with Chaupais, Chhands and all sixty Dohas.', keywords:'sundarkand sundar kand ramcharitmanas hanuman lanka सुंदरकांड सुन्दरकाण्ड हनुमान', action:'paath', target:'sundarkand' },
    { id:'paath-shiva-tandav', type:'texts', icon:'❀', title:'Shiva Tandava Stotram', hi:'शिव तांडव स्तोत्रम्', summary:'A traditional Sanskrit stotram describing the cosmic dance of Shiva.', keywords:'shiv tandav tandava stotra ravana नटराज शिव तांडव स्तोत्र', action:'paath', target:'shiv-tandav' },
    { id:'paath-bajrang-baan', type:'texts', icon:'❀', title:'Bajrang Baan', hi:'बजरंग बाण', summary:'A traditional devotional hymn to Hanuman, presented with text and meaning.', keywords:'hanuman bajrang baan बजरंग बाण हनुमान पाठ', action:'paath', target:'bajrang-baan' },
    { id:'paath-durga-chalisa', type:'texts', icon:'❀', title:'Durga Chalisa', hi:'दुर्गा चालीसा', summary:'A traditional forty-verse devotional paath in praise of Durga.', keywords:'devi durga chalisa ambe माता दुर्गा चालीसा देवी', action:'paath', target:'durga-chalisa' },
    { id:'paath-ram-raksha', type:'texts', icon:'❀', title:'Ram Raksha Stotram', hi:'राम रक्षा स्तोत्रम्', summary:'A traditional Sanskrit stotram dedicated to Shri Rama.', keywords:'rama ram raksha stotra राम रक्षा स्तोत्र श्रीराम', action:'paath', target:'ram-raksha' },

    { id:'mantra-ganesh', type:'mantras', icon:'ॐ', title:'Ganesh Mantra', hi:'गणेश मंत्र', summary:'A concise traditional salutation to Ganapati for a mindful beginning.', keywords:'ganesha ganesh ganpati vakratunda mantra विनायक गणपति गणेश मंत्र', action:'text', target:'ganesh-mantra' },

    { id:'deity-brahma', type:'deities', icon:'♆', title:'Brahma', hi:'ब्रह्मा', summary:'Associated with creation, sacred knowledge and the Vedas.', keywords:'brahma creator vedas lotus चार मुख सृष्टि ब्रह्मा वेद', action:'text', target:'brahma' },
    { id:'deity-vishnu', type:'deities', icon:'♆', title:'Vishnu', hi:'विष्णु', summary:'Preserver of cosmic order, revered through many traditions and forms.', keywords:'vishnu narayan hari preserver chakra shankha विष्णु नारायण हरि', action:'text', target:'vishnu' },
    { id:'deity-krishna', type:'deities', icon:'♆', title:'Krishna', hi:'कृष्ण', summary:'Teacher of the Bhagavad Gita, honoured through wisdom, devotion and divine play.', keywords:'krishna kanha govinda gopal flute कृष्ण कान्हा गोविन्द गोपाल', action:'text', target:'krishna' },
    { id:'deity-rama', type:'deities', icon:'♆', title:'Rama', hi:'राम', summary:'Hero of the Ramayana, remembered for dharma, courage and ideal conduct.', keywords:'rama ram siya ram maryada purushottam राम श्रीराम सिया राम', action:'text', target:'rama' },
    { id:'deity-lakshmi', type:'deities', icon:'♆', title:'Lakshmi', hi:'लक्ष्मी', summary:'Associated with auspiciousness, prosperity, beauty and well-being.', keywords:'lakshmi laxmi shri goddess lotus लक्ष्मी श्री कमल', action:'text', target:'lakshmi' },
    { id:'deity-saraswati', type:'deities', icon:'♆', title:'Saraswati', hi:'सरस्वती', summary:'Goddess of knowledge, learning, music, speech and the arts.', keywords:'saraswati veena vidya vasant panchami सरस्वती वीणा विद्या', action:'text', target:'saraswati' },
    { id:'deity-hanuman', type:'deities', icon:'♆', title:'Hanuman', hi:'हनुमान', summary:'Devotee of Rama, honoured for courage, service and unwavering bhakti.', keywords:'hanuman bajrangbali anjaneya maruti हनुमान बजरंगबली अंजनेय', action:'text', target:'hanuman' },

    { id:'aarti-durga', type:'aartis', icon:'♨', title:'Durga Aarti', hi:'दुर्गा आरती', summary:'A devotional offering to the Divine Mother in Durga traditions and festival observances.', keywords:'durga mata devi aarti दुर्गा माता देवी आरती', action:'text', target:'aarti-durga' },
    { id:'aarti-saraswati', type:'aartis', icon:'♨', title:'Saraswati Aarti', hi:'सरस्वती आरती', summary:'A devotional offering associated with learning, music, knowledge and the arts.', keywords:'saraswati vidya veena aarti सरस्वती विद्या वीणा आरती', action:'text', target:'aarti-saraswati' },
    { id:'aarti-krishna', type:'aartis', icon:'♨', title:'Krishna Aarti', hi:'कृष्ण आरती', summary:'A devotional Aarti honouring Krishna in home, temple and festival traditions.', keywords:'krishna kunj bihari aarti कृष्ण कुंज बिहारी आरती', action:'text', target:'aarti-krishna' },
    { id:'aarti-lakshmi', type:'aartis', icon:'♨', title:'Lakshmi Aarti', hi:'लक्ष्मी आरती', summary:'An offering of light to Lakshmi, recited in household and festival traditions.', keywords:'lakshmi laxmi om jai lakshmi mata aarti लक्ष्मी माता आरती', action:'text', target:'aarti-lakshmi' },
    { id:'aarti-kuber', type:'aartis', icon:'♨', title:'Kuber Aarti', hi:'कुबेर आरती', summary:'A devotional text associated with Kuber, presented with tradition and source context.', keywords:'kuber kubera dhanpati aarti कुबेर धनपति आरती', action:'text', target:'aarti-kuber' },
    { id:'aarti-ambe', type:'aartis', icon:'♨', title:'Jai Ambe Gauri', hi:'जय अम्बे गौरी', summary:'A widely recited devotional Aarti honouring the Divine Mother.', keywords:'jai ambe gauri durga mata aarti जय अम्बे गौरी आरती', action:'text', target:'aarti-ambe' },

    { id:'ritual-meditation', type:'rituals', icon:'🪔', title:'Dhyana', hi:'ध्यान', summary:'A contemplative practice of steady attention, observation and inward quiet.', keywords:'dhyana dhyan meditation contemplation ध्यान मेडिटेशन', action:'text', target:'meditation' },
    { id:'ritual-aarti', type:'rituals', icon:'🪔', title:'Aarti Practice Guide', hi:'आरती साधना मार्गदर्शिका', summary:'A safety-conscious educational guide to the devotional offering of light.', keywords:'aarti arti diya lamp worship आरती दीप पूजा', action:'text', target:'aarti' },
    { id:'ritual-fasting', type:'rituals', icon:'🪔', title:'Vrat', hi:'व्रत', summary:'An educational overview of fasting and observance with health and tradition notes.', keywords:'vrat fast fasting upvas ekadashi व्रत उपवास एकादशी', action:'text', target:'fasting' },
    { id:'ritual-charity', type:'rituals', icon:'🪔', title:'Dana', hi:'दान', summary:'A respectful guide to charity, responsibility and thoughtful giving.', keywords:'dana daan charity seva giving दान सेवा', action:'text', target:'charity' },
    { id:'ritual-yagna', type:'rituals', icon:'🪔', title:'Yajna', hi:'यज्ञ', summary:'A tradition-aware overview of sacred fire ritual and qualified guidance.', keywords:'yajna yagna havan homa fire ritual यज्ञ हवन होम', action:'text', target:'yagna' },
    { id:'ritual-japa', type:'rituals', icon:'🪔', title:'Japa', hi:'जप', summary:'A beginner overview of mantra repetition, counting and respectful practice.', keywords:'japa jap mala mantra repetition जप माला मंत्र', action:'text', target:'japa' }
  ];
  ...
  function resultCard(item, query, compact) {
    return '<article class="sfh-search-result-card' + (compact ? ' is-compact' : '') + '" data-search-type="' + item.type + '">' +
      ...
      (exact(item,query) ? '<em>Exact match</em>' : '<b>' + esc(typeLabels[item.type].replace(' & Practices','')) + '</b>') + '<i>›</i></button></article>';
  }
  ...
  function buildOverlay() {
    ...
    overlay.innerHTML = '<div class="sfh-search-backdrop" onclick="closeGlobalSearch()"></div><section class="sfh-search-dialog" role="dialog" aria-modal="true" aria-labelledby="sfh-search-title">' +
      ...
      '<footer><span>⌨ Keyboard shortcuts</span><kbd>Esc</kbd> Close <kbd>Ctrl/Cmd K</kbd> Search <small>Search stays within Sanatan for Humanity.</small></footer></section>';
